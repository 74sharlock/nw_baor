        ...
        <div class="list">
            <div class="item" v-for="man in members">
                <div class="block">
                    ...
                    <div class="mostSpend">主要花费在<span class="ui tips top black pointer underline" data-title="{{man.mostSpend.value}}">{{catResolve(man.mostSpend.key)}}</span>方面</div>
                    <div class="maxSpend">最多的一次支出:<span class="ui tips top black pointer underline" data-title="{{man.maxSpend.key}}">{{$encodeFen(man.maxSpend.value) | currency '¥'}}</span></div>
                    <div class="maxIncome">最多的一次收入:<span class="ui tips top black pointer underline" data-title="{{man.maxIncome.key}}">{{$encodeFen(man.maxIncome.value) | currency '¥'}}</span></div>
                </div>
            </div>
        </div>
    </div>
